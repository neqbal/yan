...
public class Machine {
  ...
  public Machine() {
    ...
    conf_DescFlag.put(0x01, Flag.g);
    conf_DescFlag.put(0x08, Flag.e);
    conf_DescFlag.put(0x10, Flag.n);
    conf_DescFlag.put(0x02, Flag.z);
    conf_DescFlag.put(0x00, Flag.astr);

    conf_InsByte.put(InstructionByte.opcode, 1);    
    conf_InsByte.put(InstructionByte.param1, 2);    
    conf_InsByte.put(InstructionByte.param2, 0);    

    conf_FlagOffset.put(Flag.l, 0x04);
    conf_FlagOffset.put(Flag.g, 0x01);
    conf_FlagOffset.put(Flag.e, 0x08);
    ...
    conf_DescRegister.put(0x04, Register.a);
    conf_DescRegister.put(0x10, Register.b);
    conf_DescRegister.put(0x01, Register.c);
    conf_DescRegister.put(0x20, Register.d);
    conf_DescRegister.put(0x02, Register.s);
    conf_DescRegister.put(0x40, Register.i);
    conf_DescRegister.put(0x08, Register.f);
    
    conf_RegisterOP.put(Register.a, 0x04);
    conf_RegisterOP.put(Register.b, 0x10);
    conf_RegisterOP.put(Register.c, 0x01);
    conf_RegisterOP.put(Register.d, 0x20);
    conf_RegisterOP.put(Register.s, 0x02);
    conf_RegisterOP.put(Register.i, 0x40);
    conf_RegisterOP.put(Register.f, 0x08);

    conf_DescInstruction.put(0x04, Instruction.IMM);
    conf_DescInstruction.put(0x80, Instruction.ADD);
    conf_DescInstruction.put(0x08, Instruction.STK);
    conf_DescInstruction.put(0x01, Instruction.STM);
    conf_DescInstruction.put(0x02, Instruction.LDM);
    conf_DescInstruction.put(0x20, Instruction.CMP);
    conf_DescInstruction.put(0x40, Instruction.JMP);
    conf_DescInstruction.put(0x10, Instruction.SYS);
  
    conf_InstructionOP.put(Instruction.IMM, 0x04);
    conf_InstructionOP.put(Instruction.ADD, 0x80);
    conf_InstructionOP.put(Instruction.STK, 0x08);
    conf_InstructionOP.put(Instruction.STM, 0x01);
    conf_InstructionOP.put(Instruction.LDM, 0x02);
    conf_InstructionOP.put(Instruction.CMP, 0x20);
    conf_InstructionOP.put(Instruction.JMP, 0x40);
