...
public class Machine {
  ...
  public Machine() {
    ...
    conf_DescSyscall.put(0x10, Syscall.open);
    conf_DescSyscall.put(0x20, Syscall.read_code);
    conf_DescSyscall.put(0x04, Syscall.read_memory);
    conf_DescSyscall.put(0x02, Syscall.write);
    conf_DescSyscall.put(0x08, Syscall.sleep);
    conf_DescSyscall.put(0x01, Syscall.exit);


    conf_DescFlag.put(0x08, Flag.l);
    conf_DescFlag.put(0x04, Flag.g);
    conf_DescFlag.put(0x10, Flag.e);
    conf_DescFlag.put(0x02, Flag.n);
    conf_DescFlag.put(0x01, Flag.z);
    ...
    conf_FlagOffset.put(Flag.l, 0x08);
    conf_FlagOffset.put(Flag.g, 0x04);
    conf_FlagOffset.put(Flag.e, 0x10);
    conf_FlagOffset.put(Flag.n, 0x02);
    conf_FlagOffset.put(Flag.z, 0x01);
    ...
    conf_DescRegister.put(0x02, Register.c);
    conf_DescRegister.put(0x20, Register.d);
    conf_DescRegister.put(0x04, Register.s);
    ...
    conf_RegisterOP.put(Register.c, 0x02);
    conf_RegisterOP.put(Register.d, 0x20);
    conf_RegisterOP.put(Register.s, 0x04);
    ...
    conf_DescInstruction.put(0x10, Instruction.STK);
    conf_DescInstruction.put(0x40, Instruction.STM);
    conf_DescInstruction.put(0x08, Instruction.LDM);
    conf_DescInstruction.put(0x80, Instruction.CMP);
    conf_DescInstruction.put(0x02, Instruction.JMP);
    conf_DescInstruction.put(0x20, Instruction.SYS);
  
    conf_InstructionOP.put(Instruction.IMM, 0x04);
    conf_InstructionOP.put(Instruction.ADD, 0x01);
    conf_InstructionOP.put(Instruction.STK, 0x10);
    conf_InstructionOP.put(Instruction.STM, 0x40);
    conf_InstructionOP.put(Instruction.LDM, 0x08);
    conf_InstructionOP.put(Instruction.CMP, 0x80);
    conf_InstructionOP.put(Instruction.JMP, 0x02);
    conf_InstructionOP.put(Instruction.SYS, 0x20);
  }
}
